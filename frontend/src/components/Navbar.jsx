...
const Navbar = ({ searchTerm, setSearchTerm, user}) => {
    ...
    <div className="flex gap-2 md:gap=5 w-full mt-5">
        <div className="flex justify-start item-center w-full px=2 rounded=md bg-white border-none outline-none focus-within:shadow-sm">
            <IoMdSearch fontSize={21} className="ml-1"/>
            <input type="text" 
            onChange={(x) => setSearchTerm(e.target.value)}
            placeholder="Search"
            value={seachterm}
